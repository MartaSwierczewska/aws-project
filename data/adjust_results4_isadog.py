...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for name in results_dic:
        is_image_dog = 1 if results_dic[name][0] in dognames_dic else 0
        is_classification_dog = 1 if results_dic[name][1] in dognames_dic else 0
        results_dic[name].extend([is_image_dog, is_classification_dog])
